...
const Home: FunctionComponent<HomeProps> = () => {
  ...
  return (
    <>
    <div className={`px-5 py-12 md:py-16 ${theme === 'light' 
  ...
  <div className="container mx-auto">
    <div className="text-center max-w-4xl mx-auto">
      <div className="mb-10 space-y-4">
        ...
        <h1 className={`text-4xl md:text-6xl lg:text-7xl font-extrabold mb-4 ${theme === 'light' 
          ? 'text-slate-900' 
          : 'text-white'}`}>
          Cards Showcase
        </h1>
        
        <p className={`text-xl md:text-2xl max-w-3xl mx-auto ${theme === 'light' 
          ? 'text-slate-600' 
          : 'text-slate-300'}`}>
